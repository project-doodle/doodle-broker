...
public final class RSocketRoutingBrokerInfoCodec {
  ...
  public static ByteBuf encode(
      ...
      int flags) {
    ByteBuf byteBuf = RSocketRoutingFrameHeaderCodec.encode(allocator, BROKER_INFO, flags);
  ...
  public static RSocketRoutingTags tags(ByteBuf byteBuf) {
    int offset = BYTES + ROUTE_ID_BYTES + Long.BYTES;
    return decodeTag(offset, byteBuf);
  }

  private RSocketRoutingBrokerInfoCodec() {}
}
